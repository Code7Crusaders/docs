...
le capacità avanzate di un LLM per comprendere e generare risposte personalizzate. 
...
\begin{itemize}
    ...
    \item \textbf{Analisi LLM} \\ \url{https://code7crusaders.github.io/docs/pdf/altri_documenti/analisi_LLM_Bloom_Openai_gpt4/analisi_modelli.pdf}
    \item \textbf{LangChain} \\ \url{https://python.langchain.com/docs/introduction/}
