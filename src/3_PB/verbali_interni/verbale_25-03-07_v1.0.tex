...
\begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
    1.0 & 11/03/2025 & Gabriele Di Pietro &  & Stesura del Documento \\ 
...
iniziato a pensare alle architetture da utilizzare per il prodotto. Inizialmente abbiamo pensato di utilizzare un'architettura monolitica vista la semplicità e il poco tempo a disposizione, tuttavia l'azienda ieri ci ha inviato
...
Il giorno **4/03/2025** abbiamo avuto un colloquio online con l'azienda Ergon nella quale abbiamo rinegoziato alcuni dei requisiti. Durante l'incontro, ci è stato proposto di trovare un giorno per effettuare un incontro nella loro sede. Ripensando al colloquio svolto per la RTB, dove ci è stato chiesto se avessimo visitato la sede, abbiamo deciso di accettare la proposta e ci stiamo organizzando per trovarci tutti. 
\subsection{Comprensione della valutazione RTB}
Abbiamo iniziato a correggere gli errori fatti per la documentazione della RTB, in particolare abbiamo corretto il documento di analisi dei requisiti. Tuttavia alcune correzioni non sono molto chiare e quindi abbiamo deciso di dividerci in gruppi per lavorare su dei documenti e capire meglio cosa ci è stato chiesto.
\subsection{Ripresa dell'attività del diario di bordo}
Lunedì **10/03/2025** ricomincerà l'attività settimanale del diario di bordo stavolta online e alle ore 12:00. Questo significa che fino alla consegna dovremmo organizzarci nel fare le slide per la presentazione e dividerci in turni per chi presenta.
