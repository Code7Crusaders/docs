...
L'\href{https://code7crusaders.github.io/docs/PB/documentazione_interna/glossario.html#analisi-dei-requisiti}{\textbf{Analisi dei Requisiti\textsuperscript{G}} v1.0}, redatto dagli Analisti, rappresenta un documento fondamentale per lo sviluppo del sistema software. Il suo obiettivo principale è definire in dettaglio le funzionalità necessarie affinché il prodotto soddisfi pienamente le richieste della Proponente.
...
L'\href{https://code7crusaders.github.io/docs/PB/documentazione_interna/glossario.html#analisi-dei-requisiti}{\textbf{Analisi dei Requisiti\textsuperscript{G}} v1.0} è un documento redatto dagli Analisti che comprende i seguenti aspetti:
\begin{itemize}
...
Un tipo di diagramma UML molto diffuso nella progettazione software è il \textbf{diagramma delle classi}, che rappresenta la struttura statica di un sistema evidenziando classi, attributi, metodi e le connessioni tra di esse.
...
\subsubsubsubsection{Convenzioni sui metodi}
...
\subsubsubsubsection{Relazioni tra le classi}
...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{../../../img/composizione_classi.png}
        \caption{Esempio di composizione}
        \label{fig:composizione_classi}
    \end{figure}
    \item \textbf{Ereditarietà (Generalizzazione)}: descrive una relazione gerarchica tra una superclasse e una o più sottoclassi, che ne ereditano gli attributi e metodi. È raffigurata con una linea e una freccia vuota che punta dalla sottoclasse alla superclasse.
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{../../../img/ereditarieta_classi.png}
        \caption{Esempio di generalizzazione}
        \label{fig:generalizzazione_classi}
    \end{figure}
    \item \textbf{Realizzazione}: rappresenta l'implementazione di un'interfaccia da parte di una classe concreta. È indicata con una linea tratteggiata con una freccia vuota dalla classe implementatrice all'interfaccia.
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{../../../img/realizzazione_classi.png}
        \caption{Esempio di realizzazione}
        \label{fig:realizzazione_classi}
    \end{figure}
\end{itemize}
