...
\subsubsection{U.C.6.3 Visualizza Errore Credenziali Errate}
\begin{itemize}
    \item \textbf{Attore}: Utente
...
\subsubsection{U.C.6.4 Caratteri non Validi}
\begin{itemize}
    \item \textbf{Attore}: Utente
...
\subsubsection{U.C.7.6 Visualizza Errore durante la Registrazione}
\begin{itemize}
    \item \textbf{Attore}: Utente
...
\begin{itemize}
    \item \textbf{Attore}: Utente
    \item \textbf{Precondizioni}: L’utente ha ricevuto una risposta non soddisfacente dal sistema basato su \href{https://code7crusaders.github.io/docs/PB/documentazione_interna/glossario.html#llm-large-language-model}{\textit{LLM}\textsuperscript{G}}.
...
\subsubsection{U.C.23: Visualizzazione Template di Domanda e Risposta}
\begin{itemize}
