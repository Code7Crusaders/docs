...
\begin{itemize}
    ...
    \item \textbf{Minori costi di infrastruttura}: Non è necessario investire in strumenti di orchestrazione, o gestione della comunicazione tra microservizi.
...
Dopo un’analisi approfondita, il team di sviluppo ha deciso di adottare un’\textbf{architettura esagonale monolitica}. Questa scelta è stata motivata dai seguenti fattori:
\begin{enumerate}
