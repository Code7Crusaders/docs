...
\definecolor{CO}{HTML}{93b7be}  
\definecolor{DIP}{HTML}{90be6d}  
\definecolor{DIV}{HTML}{6BAED6}  
\definecolor{LA}{HTML}{ffd373}  
\definecolor{PA}{HTML}{a874d2}  
\definecolor{PI}{HTML}{FF8F00}  
\definecolor{RI}{HTML}{a98467}  
\definecolor{extra}{HTML}{E53946}
            ...
            \subsection{Pianificazione delle Attività}
                ...
                \resizebox{\textwidth}{!}{ % Scales the chart to fit the text width
                    \begin{ganttchart}[
                        ...
                        milestone/.append style={fill=red!70}, % \href{https://code7crusaders.github.io/docs/PB/documentazione_interna/glossario.html#milestone}{Milestone\textsuperscript{G}} style
    ...
    % TODO Sistemare gli sprint con le caratteristiche elencate qui sopra
        ...
        \subsection{Requirements and Technology Baseline (RTB)}
            \subsubsection{Sprint 1}
                ...
                \begin{figure}[H]
                    \centering
                    \begin{tikzpicture}
                        \pie[polar]{11/Responsabile, 13/Amministratore, 13/Analista, 20/Progettista, 43/Verificatore}
                    \end{tikzpicture}
                ...
                \begin{table}[H]
                    ...
                    \begin{tabular}{|c|c|c|c|c|c|c|c|}
                        ...
                        Totale        & 3   & 3,5 & 3,5 & 3,5 & -  & 14 \textcolor{red}{(+2)} &                    \\ \hline
                        \end{tabular}
            ...
            \subsubsection{Sprint 3}
                ...
                \begin{figure}[H]
                    \centering
                    \begin{tikzpicture}
                        \pie[polar]{9/Responsabile, 10/Amministratore, 10/Analista, 16/Progettista, 21/Programmatore, 30/Verificatore}
                    \end{tikzpicture}
            ...
            \subsubsection{Sprint 4}
                ...
                \begin{figure}[H]
                    \centering
                    \begin{tikzpicture}
                        \pie[polar]{8/Responsabile, 10/Amministratore, 10/Analista, 15/Progettista, 23/Programmatore, 28/Verificatore}
                    \end{tikzpicture}
                ...
                \begin{table}[H]
                    ...
                    \begin{tabular}{|c|c|c|c|c|c|c|c|}
                        \hline
                        & Re & Am & An & Pj & Pg & Ve & Totale per persona \\ \hline
                        Cotti Cottini & - & - & - & - & - & 6 & 6 \\ \hline
                        Di Pietro & - & - & 4.5 & - & - & - & 4.5 \\ \hline
                        Diviesti & - & 1.5 & - & - & - & - & 1.5 \\ \hline
                        Lapenna & - & - & - & - & 8 & - & 8 \\ \hline
                        Pan & - & - & - & - & - & 5 & 5 \\ \hline
                        Pinarello & - & - & - & 5.5 & - & - & 5.5 \\ \hline
                        Rizzolo & 3 & - & - & - & - & - & 3 \\ \hline
                        Totale & 3 & 1.5 & 4.5 & 5.5 & 8 & 11 & \\ \hline
                    \end{tabular}
            ...
            \subsubsection{Sprint 5}
                ...
                \begin{figure}[H]
                    \centering
                    \begin{tikzpicture}
                        \pie[polar]{9/Responsabile, 10/Amministratore, 7/Analista, 16/Progettista, 23/Programmatore, 29/Verificatore}
                    \end{tikzpicture}
            ...
            \subsubsection{Sprint 6}
                ...
                \begin{figure}[H]
                    \centering
                    \begin{tikzpicture}
                        \pie[polar]{8/Responsabile, 10/Amministratore, 10/Analista, 15/Progettista, 27/Programmatore, 27/Verificatore}
                    \end{tikzpicture}
            ...
            \subsubsection{Sprint 7}
                ...
                \begin{figure}[H]
                    \centering
                    \begin{tikzpicture}
                        \pie[polar]{8/Responsabile, 10/Amministratore, 10/Analista, 15/Progettista, 28/Programmatore, 28/Verificatore}
                    \end{tikzpicture}
            ...
            \subsubsection{Sprint 8}
                ...
                \begin{figure}[H]
                    \centering
                    \begin{tikzpicture}
                        \pie[polar]{9/Responsabile, 10/Amministratore, 10/Analista, 16/Progettista, 23/Programmatore, 29/Verificatore}
                    \end{tikzpicture}
                ...
                \begin{table}[H]
                    ...
                    \begin{tabular}{|c|c|c|c|c|c|c|c|}
                        ...
                        Lapenna & - & - & 3.5 & - & - & - & 3.5 \\ \hline
                        Pan & - & - & - & - & - & 5 & 5 \\ \hline
                        Pinarello & - & - & - & - & 12 & - & 12 \\ \hline
                        Rizzolo & - & 1 & - & - & - & - & 1 \\ \hline
                        Totale & 3 & 1 & 3.5 & 8 & 12 & 12 & \\ \hline
                    \end{tabular}
            ...
            \subsubsection{Sprint 13}
                ...
                \begin{table}[H]
                    ...
                    \begin{tabular}{|c|c|c|c|c|c|c|c|}
                        \hline
                        & Re & Am & An & Pj & Pg & Ve & Totale per persona \\ \hline
                        Cotti Cottini & - & - & - & - & 13 & - & 13 \\ \hline
                        Di Pietro & - & 3.5 & - & - & - & - & 3.5 \\ \hline
                        Diviesti & - & - & - & - & - & 6 & 6 \\ \hline
                        Lapenna & 3 & - & - & - & - & - & 3 \\ \hline
                        Pan & - & - & 8 & - & - & - & 8 \\ \hline
                        Pinarello & - & - & - & - & - & 4.5 & 4.5 \\ \hline
                        Rizzolo & - & 3.5 & - & - & - & - & 3.5 \\ \hline
                        Totale & 3 & 3.5 & 3.5 & 8 & 13 & 10.5 & \\ \hline
                    \end{tabular}
            ...
            \subsubsection{Sprint 14}
                ...
                \begin{figure}[H]
                    \centering
                    \begin{tikzpicture}
                        \pie[polar]{8/Responsabile, 10/Amministratore, 10/Analista, 16/Progettista, 28/Programmatore, 28/Verificatore}
                    \end{tikzpicture}
                ...
                \begin{table}[H]
                    ...
                    \begin{tabular}{|c|c|c|c|c|c|c|c|}
                        ...
                        Pan & - & 4.5 & - & - & - & - & 4.5 \\ \hline
                        Pinarello & - & 4.5 & - & - & - & - & 4.5 \\ \hline
                        Rizzolo & - & - & - & - & - & 13.5 & 13.5 \\ \hline
                        Totale & 3 & 4.5 & 4.5 & 6.5 & 10 & 18.5 & \\ \hline
                    \end{tabular}
            ...
            \subsubsection{Sprint 15}
                ...
                \begin{figure}[H]
                    \centering
                    \begin{tikzpicture}
                        \pie[polar]{6/Responsabile, 11/Amministratore, 11/Analista, 17/Progettista, 25/Programmatore, 31/Verificatore}
                    \end{tikzpicture}
                ...
                \begin{table}[H]
                    ...
                    \begin{tabular}{|c|c|c|c|c|c|c|c|}
                        ...
                        Lapenna & - & - & 4 & - & - & - & 4 \\ \hline
                        Pan & - & - & - & - & - & 6 & 6 \\ \hline
                        Pinarello & - & - & - & - & 12.5 & - & 12.5 \\ \hline
                        Rizzolo & - & 2 & - & - & - & - & 2 \\ \hline
                        Totale & 3 & 2 & 4 & 5.5 & 12.5 & 13 & \\ \hline
                    \end{tabular}
                    \caption{Consuntivo orario per ruolo nello Sprint 15}
                \end{table}                
                ...
                \definecolor{re}{HTML}{6666f6}  
                \definecolor{am}{HTML}{77d2f3}  
                \definecolor{an}{HTML}{fdf399}  
                \definecolor{pj}{HTML}{f4b572}  
                \definecolor{pg}{HTML}{ed6f6b}  
                \definecolor{ve}{HTML}{74a0f8} 

                \begin{figure}[H]
                    \centering
                    \begin{tikzpicture}
                        \pie[polar]{8.3/Responsabile, 9.7/Amministratore, 10.2/Analista, 16.9/Progettista, 22.2/Programmatore, 32.7/Verificatore}
                    \end{tikzpicture}
                ...
                \begin{figure}[H]
                    ...
                    \begin{tikzpicture}
                        ...
                        % Responsabile (1350) 
                        \addplot[fill=re] coordinates {(p1,1350) (p2,0) (p3,0) (p4,0) (p5,0) (p6,0)};  
                        % Amministratore (1050) 
                        \addplot[fill=am] coordinates {(p1,0) (p2,1050) (p3,0) (p4,0) (p5,0) (p6,0)};  
                        % Analista (1388) 
                        \addplot[fill=an] coordinates {(p1,0) (p2,0) (p3,1388) (p4,0) (p5,0) (p6,0)};  
                        % Progettista (2288) 
                        \addplot[fill=pj] coordinates {(p1,0) (p2,0) (p3,0) (p4,2288) (p5,0) (p6,0)};  
                        % Programmatore (1800)
                        \addplot[fill=pg] coordinates {(p1,0) (p2,0) (p3,0) (p4,0) (p5,1800) (p6,0)};  
                        % Verificatore (2655)
                        \addplot[fill=ve] coordinates {(p1,0) (p2,0) (p3,0) (p4,0) (p5,0) (p6,2655)};  
                
                        \legend{Responsabile, Amministratore, Analista, Progettista, Programmatore, Verificatore}
                        \end{axis}
                    \end{tikzpicture}
                    \caption{Consuntivo economico per ruolo nel periodo RTB}
                \end{figure}
        ...
        \subsection{PB}
            ...
            \begin{figure}[H]
                \centering
                \begin{tikzpicture}
                    \pie[polar]{5/Responsabile, 10/Amministratore, 10/Analista, 12/Progettista, 33/Programmatore, 30/Verificatore}
                \end{tikzpicture}
            ...
            \begin{table}[H]
                ...
                \begin{tabular}{|c|c|c|c|c|c|c|c|}
                    \hline
                    & Re & Am & An & Pj & Pg & Ve & Totale per persona \\ \hline
                    Cotti Cottini & - & - & - & 4.5 & - & - & 4.5 \\ \hline
                    Di Pietro & 1 & - & - & - & - & - & 1 \\ \hline
                    Diviesti & - & - & 2 & - & - & - & 2 \\ \hline
                    Lapenna & - & - & - & - & - & 2.5 & 2.5 \\ \hline
                    Pan & - & 3 & - & - & - & - & 3 \\ \hline
                    Pinarello & - & - & - & - & - & 1 & 1 \\ \hline
                    Rizzolo & - & - & - & - & 12.5 & - & 12.5 \\ \hline
                    Totale & 1 & 3 & 2 & 4.5 & 12.5 & 3.5 & \\ \hline
                \end{tabular}
            ...
            \begin{figure}[H]
                \centering
                \begin{tikzpicture}
                    \pie[polar]{5/Responsabile, 8/Amministratore, 8/Analista, 14/Progettista, 33/Programmatore, 32/Verificatore}
                \end{tikzpicture}
            ...
            \begin{table}[H]
                ...
                \begin{tabular}{|c|c|c|c|c|c|c|c|}
                    ...
                    Pinarello & - & - & - & - & - & 3 & 3 \\ \hline
                    Rizzolo & 1 & - & - & - & - & - & 1 \\ \hline
                    Totale & 1 & 5.5 & 2.5 & 2.5 & 1 & 6 & \\ \hline
                \end{tabular}
            ...
            \begin{figure}[H]
                \centering
                \begin{tikzpicture}
                    \pie[polar]{7/Responsabile, 10/Amministratore, 10/Analista, 14/Progettista, 29/Programmatore, 30/Verificatore}
                \end{tikzpicture}
            ...
            \begin{figure}[H]
                \centering
                \begin{tikzpicture}
                    \pie[polar]{10/Responsabile, 7/Amministratore, 7/Analista, 15/Progettista, 32/Programmatore, 29/Verificatore}
                \end{tikzpicture}
            ...
            \begin{figure}[H]
                \centering
                \begin{tikzpicture}
                    \pie[polar]{9/Responsabile, 10/Amministratore, 9/Analista, 12/Progettista, 31/Programmatore, 29/Verificatore}
                \end{tikzpicture}
            ...
            \begin{table}[H]
                ...
                \begin{tabular}{|c|c|c|c|c|c|c|c|}
                    ...
                    Cotti Cottini & - & - & - & 5 & - & - & 5 \\ \hline
                    Di Pietro & - & 2 & - & - & - & - & 2 \\ \hline
                    Diviesti & - & - & - & - & 7.5 & - & 7.5 \\ \hline
                    Lapenna & - & - & - & - & 6.5 & - & 6.5 \\ \hline
                    Pan & - & - & - & - & 3 & - & 3 \\ \hline
                    Pinarello & 2 & - & - & - & - & - & 2 \\ \hline
                    Rizzolo & - & - & 1 & - & - & - & 1 \\ \hline
                    Totale & 2 & 2 & 1 & 5 & 6.5 & 10.5 & \\ \hline
                \end{tabular}
            ...
            \begin{figure}[H]
                \centering
                \begin{tikzpicture}
                    \pie[polar]{7/Responsabile, 12/Amministratore, 7/Analista, 14/Progettista, 31/Programmatore, 29/Verificatore}
                \end{tikzpicture}
            ...
            \section{Consuntivo Finale Individuale}
            \begin{table}[H]
                \centering
                \resizebox{\textwidth}{!}{%
                \begin{tabular}{|l|c|c|c|c|c|c|c|c|}
                    \hline
                    \textbf{Persona} & \textbf{Re} & \textbf{Am} & \textbf{An} & \textbf{Pj} & \textbf{Pg} & \textbf{Ve} & \textbf{Tot} & \textbf{Costo Consuntivo} \\ \hline
                    Cotti Cottini & 9 & 9 & 9.5 & 15 & 23 & 29.5 & 95 & €1,850.00 \\ \hline
                    Di Pietro     & 8 & 9 & 9   & 17 & 20 & 32   & 95 & €1,850.00 \\ \hline
                    Diviesti      & 6 & 8.5 & 10 & 13.5 & 25.5 & 31.5 & 95 & €1,792.50 \\ \hline
                    Lapenna       & 8 & 9 & 11  & 16.5 & 23.5 & 27 & 95 & €1,865.00 \\ \hline
                    Pan           & 6 & 10.5 & 9 & 14.5 & 19 & 36 & 95 & €1,802.50 \\ \hline
                    Pinarello     & 8 & 8 & 9.5 & 16.5 & 24.5 & 28.5 & 95 & €1,845.00 \\ \hline
                    Rizzolo       & 9 & 10 & 8  & 15 & 22.5 & 30.5 & 95 & €1,840.00 \\ \hline
                    \textbf{Totale} & \textbf{54} & \textbf{64} & \textbf{66} & \textbf{108} & \textbf{158} & \textbf{213} & \textbf{665} & \textbf{€12,805.00} \\ \hline
                \end{tabular}%
                }
                \caption{Totale Consuntivo ore e costi a persona per ruolo }
            \end{table}
            
            \vspace{0.5cm}
            
            \noindent\textbf{Costo Consuntivo per Ruolo:}
            \begin{itemize}
                \item \textbf{Responsabile (€30/h):} €1,620.00
                \item \textbf{Amministratore (€20/h):} €1,280.00
                \item \textbf{Analista (€25/h):} €1,650.00
                \item \textbf{Progettista (€25/h):} €2,700.00
                \item \textbf{Programmatore (€15/h):} €2,370.00
                \item \textbf{Verificatore (€15/h):} €3,225.00
            \end{itemize}
            

            \paragraph{Analisi Finale}
            Il consuntivo finale mostra che tutti i membri del team hanno rispettato le ore previste, senza registrare scostamenti rilevanti. Il costo complessivo del progetto si è mantenuto all'interno del budget stimato, a conferma di una gestione efficiente delle risorse e delle attività pianificate.
