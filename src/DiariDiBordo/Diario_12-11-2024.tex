...
\begin{frame}
    \begin{alertblock}{Questioni urgenti, Punti da Approfondire}
        \begin{itemize}
            \item Come organizzare bene il glossario % è possibile fare un glossario interattivo? nei file latex link verso il glossario presente su una pagina web?
            % \item è possibile introdurre un automatismo concatenare build di file \LaTeX e deployment dei file aggiornati sul sito web? 
        \end{itemize}
    \end{alertblock}
\end{frame}
