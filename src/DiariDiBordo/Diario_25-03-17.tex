...
\begin{frame}
    \begin{block}{Attività Completate}
        \begin{itemize}
            \item Contattata l'azienda per un incontro finalizzato alla decisione del pattern architetturale da utilizzare.
            \item Contattato il professore Cardin per discutere del pattern deciso e alcuni dubbi sul diagramma delle classi.
            \item Sistemati link del glossario.
            \item Iniziato lo sviluppo della parte di backend.
        \end{itemize}
    \end{block}
\end{frame}
...
\begin{frame}
    \begin{block}{Attività Pianificate}
        \begin{itemize}
            \item Decidere una data per l'incontro in presenza con l'azienda.
            \item Terminare lo sviluppo della parte di backend.
            \item Iniziare lo sviluppo della parte di frontend.
            \item Completare la correzione dei documenti rimanenti.
        \end{itemize}
    \end{block}
\end{frame}
...
\begin{frame}
    \begin{alertblock}{Sfide Recenti}
        \begin{itemize}
            \item Alcune incertezze avuto riguardo ai pattern architetturali da utilizzare.
        \end{itemize}
    \end{alertblock}
\end{frame}
