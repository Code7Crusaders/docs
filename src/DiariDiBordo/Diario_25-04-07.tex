...
\begin{frame}
    \begin{exampleblock}{Attività Completate}
        \begin{itemize}
            \item La stesura del manuale utente
            \item Completato lo sviluppo frontend
            \item Completati collegamenti con il backend 
            \item Fissato colloquio con il professor Cardin
        \end{itemize}
    \end{exampleblock}
\end{frame}
...
\begin{frame}
    \begin{block}{Attività Pianificate}
        \begin{itemize}
            \item Effettuare l'incontro con il professor Cardin
