...
\begin{frame}
    \begin{exampleblock}{Attività Completate}
        \begin{itemize}
            ...
            \item Sviluppo metriche per monitorare l'andamento del progetto con relativi grafici (Piano di Qualifica)
            \item Modifica e approvazione dei casi d'uso da parte dell'Azienda
            \item Test in locale di vari modelli LLM per scegliere quale utilizzare
            \item Riunione con l'Azienda e scelta definitiva modello (gpt-o4-mini di OpenAI)
        \end{itemize}
    \end{exampleblock}
\end{frame}
...
\begin{frame}
    \begin{block}{Attività Pianificate}
        \begin{itemize}
            \item Continuare documentazione (Piano di Progetto e Analisi dei Requisiti)
            \item Aggiornare Glossario e Sito
            \item Scegliere il framework per la creazione dell'interfaccia grafica e scegliere db
            \item Contattare prof. Cardin per fissare un colloquio
            \item Definire primi Test statici e di Unità
        \end{itemize}
    \end{block}
\end{frame}
...
\begin{frame}
    \begin{alertblock}{Sfide Recenti}
        \begin{itemize}
            \item Capire il funzionamento di LangChain
            \item Studio per scelta del modello LLM migliore per qualità-prezzo 
        \end{itemize}
    \end{alertblock}
\end{frame}
