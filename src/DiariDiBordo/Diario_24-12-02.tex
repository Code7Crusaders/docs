...
\begin{frame}
    \begin{block}{Attività Completate}
        \begin{itemize}
            \item Temrinata la prima stesura delle Norme di Progetto.
...
\begin{frame}
    \begin{block}{Attività Pianificate}
        \begin{itemize}
            \item Analisi dei requisiti: approvazione casi d'uso, finire requisiti
...
\begin{frame}
    \begin{exampleblock}{Questioni urgenti, Punti da Approfondire}
        \begin{itemize}
            ...
            \item PoC: informazioni più precise
        \end{itemize}
    \end{exampleblock}
\end{frame}
