...
\begin{frame}
    \begin{block}{Attività Completate}
        \begin{itemize}
            \item Portato il documento di Piano di Progetto allo stesso livello degli altri.
            \item Organizzata una riunione per definire e distribuire i compiti finali prima della revisione.
            \item Revisionati casi d'uso.
        \end{itemize}
    \end{block}
\end{frame}
...
\begin{frame}
    \begin{block}{Attività Pianificate}
        \begin{itemize}
            \item Completare i compiti assegnati.
            \item Ultimare PoC con dati forniti dall'azienda.
...
\begin{frame}
    \begin{alertblock}{Sfide Recenti}
        \begin{itemize}
            \item Distribuzione carico di lavoro per gli ultimi compiti.
        \end{itemize}
    \end{alertblock}
\end{frame}
