...
\begin{frame}
    \begin{exampleblock}{Attività Completate}
        \begin{itemize}
            \item Colloquio con prof. Cardin
            \item Analisi Framework Front-End 
            \item Continuato documentazione
...
\begin{frame}
    \begin{block}{Attività Pianificate}
        \begin{itemize}
            \item Correzione casi d'uso 
            \item Continuare documentazione
            \item Scelta del DB
            \item Back-end PoC
            \item Realizzazione della bozza Design della Webapp (Figma)
        \end{itemize}
    \end{block}
\end{frame}
