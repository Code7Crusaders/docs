...
\begin{frame}
    \begin{exampleblock}{Attività Completate}
        \begin{itemize}
            \item Contattato l'azienda per feedback su Casi d'uso
            \item Miglioramento Piano di progetto
            \item Testati vari LLM
            \item Iniziato Piano di qualifica
        \end{itemize}
    \end{exampleblock}
\end{frame}
...
\begin{frame}
    \begin{exampleblock}{Attività Pianificate}
        \begin{itemize}
            \item Continuare con la documentazione
            \item Capire con l'azienda che LLM usare
            \item Definire architettura del sistema
        \end{itemize}
    \end{exampleblock}
\end{frame}
